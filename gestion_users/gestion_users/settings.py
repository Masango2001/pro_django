"""
Django settings for gestion_users project.
...
SECRET_KEY = 'django-insecure-jo8l$57p^d#p*27#$)jqbi&q-p!+acacj4)no_8(@es+63p%+y'
...
ROOT_URLCONF = 'gestion_users.urls'
...
WSGI_APPLICATION = 'gestion_users.wsgi.application'
